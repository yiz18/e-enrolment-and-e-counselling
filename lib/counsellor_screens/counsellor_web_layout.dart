...
/// A responsive wrapper that adds a persistent left sidebar to counsellor screens.
///
...
class CounsellorWebLayout extends StatelessWidget {
  final Widget child;
  final int selectedIndex;

  const CounsellorWebLayout({
    super.key,
    required this.child,
...
class _CounsellorSidebar extends StatelessWidget {
  final int selectedIndex;
  final void Function(int index) onTap;

  const _CounsellorSidebar({
    required this.selectedIndex,
    required this.onTap,
  });
